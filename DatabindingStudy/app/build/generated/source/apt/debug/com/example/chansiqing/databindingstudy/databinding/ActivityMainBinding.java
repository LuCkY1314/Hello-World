...
public class ActivityMainBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private com.example.chansiqing.databindingstudy.data.AllFloorData mItem;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.item == variableId) {
            setItem((com.example.chansiqing.databindingstudy.data.AllFloorData) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setItem(@Nullable com.example.chansiqing.databindingstudy.data.AllFloorData Item) {
    ...
    @Nullable
    public com.example.chansiqing.databindingstudy.data.AllFloorData getItem() {
        return mItem;
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeItem((com.example.chansiqing.databindingstudy.data.AllFloorData) object, fieldId);
        }
        return false;
    }
    private boolean onChangeItem(com.example.chansiqing.databindingstudy.data.AllFloorData Item, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        com.example.chansiqing.databindingstudy.data.AllFloorData item = mItem;
        ...
        if ((dirtyFlags & 0x7L) != 0) {
            ...
            android.databinding.adapters.TextViewBindingAdapter.setText(this.mboundView1, itemText);
        }
    }
    ...
    public static ActivityMainBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityMainBinding>inflate(inflater, com.example.chansiqing.databindingstudy.R.layout.activity_main, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ActivityMainBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(com.example.chansiqing.databindingstudy.R.layout.activity_main, null, false), bindingComponent);
    }
    @NonNull
