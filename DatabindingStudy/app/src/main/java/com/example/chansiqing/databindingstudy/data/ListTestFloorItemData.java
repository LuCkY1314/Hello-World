 ...
 *
 * @author: chansiqing
 * @date: 2018-10-31 18:40
 */
public class ListTestFloorItemData extends BaseData {
    ...
    protected ListTestFloorItemData(Parcel in) {
    ...
    public static final Creator<ListTestFloorItemData> CREATOR = new Creator<ListTestFloorItemData>() {
        @Override
        public ListTestFloorItemData createFromParcel(Parcel source) {
            return new ListTestFloorItemData(source);
        }

        @Override
        public ListTestFloorItemData[] newArray(int size) {
            return new ListTestFloorItemData[size];
        }
    };
}
